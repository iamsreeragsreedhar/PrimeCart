  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CartBloc, CartState>(
      ...
      builder: (context, state) {
        print("CheckoutPage State: ${state.SelectCheckoutdetails}");
        return Scaffold(
          body: SafeArea(
            child: Padding(
                                ...
                                ? Image.network(
                                    state
                                        ...
                                        ? state
                                              .SelectCheckoutdetails!
                                              .thumbnail[0]
                                        : 'https://i.pinimg.com/736x/7c/02/83/7c0283b0f00b9c6dc9da872ef9f2c268.jpg',
                                    fit: BoxFit.contain,
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8.h),
                              Text(
                                state.SelectCheckoutdetails!.productPrice
                                    .toString(),
                                style: TextStyle(
                                  fontSize: 16.sp,
                                  fontWeight: FontWeight.w600,
